...
class PositionPolicy
{
    ...
    {
        return in_array($user->user_type, ['applicant', 'client', 'staff', 'administrator', 'super-user']);
    }
    ...
    {
        return ($user->user_type === 'client' && $position->user_id === $user->id) ||
            in_array($user->user_type, ['staff', 'administrator', 'super-user']);
    }
    ...
    /*
     * Determine if the user can search position
     */
